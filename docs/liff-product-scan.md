...
- **1D tips:** hold about a hand’s width away and center the bars in the guide — do **not** fill the box (macro distance softens focus). Small sticker codes like `16052911` need that mid-range. Random wrong numbers are filtered by dropping ITF/Codabar and requiring 3 identical frame hits.
