            ...
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => setOpenAdjustStockDialog(true)}
                >
                  Adjust stock
                </Button>
              </div>
