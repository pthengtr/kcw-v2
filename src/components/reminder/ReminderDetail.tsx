...
export default function ReminderDetail({ onDeleted }: Props) {
  ...
  return (
    <div className="flex flex-col gap-6 pt-10 px-1 pb-4 md:p-6 md:pt-6">
      {/* ===== Sticky header ===== */}
      ...
      <div className="sticky top-0 z-10 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b">
        <div className="flex flex-wrap items-start justify-between gap-3 pr-10 pl-1 py-3 md:items-center md:px-6 md:pr-12">
