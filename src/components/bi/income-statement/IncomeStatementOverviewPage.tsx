        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              รายได้·ซื้อจากสมุดภาษี + ค่าใช้จ่ายบริษัททั้งก้อน (แอป expense) ·
              ประมาณการภาษีเงินได้ {(overview?.cit_rate ?? 0.2) * 100}% ·
              พยากรณ์สิ้นงวด/สิ้นปี · ภาพรวมทั้งกิจการอยู่ที่ กำไรขาดทุน (ทั้งกิจการ)
            </p>
